...
ASCII_CHARS = '@&B9#SGHMh352AXsri;:,. '[::-1]
...
def map_pixels_to_ascii_chars(image, range_width=(255.0/(len(ASCII_CHARS) - 1))):
...
def convert_image_to_ascii(image, new_width=470, new_height=120):
